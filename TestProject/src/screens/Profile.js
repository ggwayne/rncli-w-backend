...
export default function Profile() { // Updated component name
  ...
  return (
    <View style={styles.appContainer}>
      ...
      <Image source={profile} style={styles.profile} />
        ...
        <Image source={username} style={[styles.profileicons, { top: 45, left: 50 }]}/>
        <Image source={email} style={[styles.profileicons, { top: 110, left: 50 }]}/>
        <Image source={phone} style={[styles.profileicons, { top: 180, left: 50 }]}/>

          <Text style={styles.infoP}>Juan Dela Cruz</Text>
